...
function loadNeedleGraph(id, from, until) {
	...
	// var graph0 = new Rickshaw.Graph.Ajax({
	// element : document.querySelector("#chart0"),
	// renderer : 'line',
	// interpolation : 'linear',
	// min : 'auto',
	// dataURL : "/bayeos-sax/rest/app/GetDataToId/" + id + "/" + from + "/"
	// + until,
	...
	// var preview0 = new Rickshaw.Graph.RangeSlider({
	// graph : graph,
	// element : document.getElementById('preview0'),
	// });
	// preview0.slideCallbacks = [ set_from_until ];
	//
	// graph.onUpdate(function f() {
	...
	// });
	//
	// var legend0 = new Rickshaw.Graph.Legend({
	// graph : graph,
	// element : document.getElementById('legend0')
	//
	// });
	//
	// var shelving0 = new Rickshaw.Graph.Behavior.Series.Toggle({
	// graph : graph,
	// legend : legend0
	// });
	//
	// var order0 = new Rickshaw.Graph.Behavior.Series.Order({
	// graph : graph,
	// legend : legend0
	// });
	//
	// var highlighter0 = new Rickshaw.Graph.Behavior.Series.Highlight({
	// graph : graph,
	// legend : legend0
	// });
	//
